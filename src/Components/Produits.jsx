...
const Produits = ({ selectedCategory }) => {
  ...
  return (
    <div className="p-8">
      <h2 className="text-black text-opacity-70 mb-6 font-bold text-2xl text-center">Nos Produits</h2>
      <div className="w-[90%] mx-auto">
        <h2 className="text-black text-opacity-65 mb-6 font-semibold text-2xl">Explorez Nos Produits</h2>
            ...
            >
              <div className="bg-[#243645] bg-opacity-5 shadow-sm rounded-sm overflow-hidden relative">
                ...
                <div className={`absolute bottom-0 left-0 w-full text-center ${hoveredProduct === product.id ? 'opacity-100' : 'opacity-0'} transition-opacity duration-300 ease-in-out`}>
                  <button className="bg-[#243645] text-white px-2 py-1 rounded-bl-sm rounded-br-sm transition-colors duration-200 w-full">
                    Ajouter au panier
                  </button>
                </div>
              ...
              <div className="p-2 bg-white shadow-md flex flex-col justify-between flex-grow h-30">
                ...
                <div className="flex items-center justify-between mr-[2%] md:mr-[2%]">
        ...
        <div className="flex justify-center mt-4">
          {[...Array(Math.ceil(produits.length / productsPerPage))].map((_, index) => (
            <button
              key={index}
