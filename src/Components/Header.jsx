...
import NotificationIcon from '../Images/notification.svg'; // Assurez-vous que ce chemin est correct
    ...
    return (
        <header className="flex items-center justify-between p-4 bg-[#FAFAFA] shadow-md">
            ...
            <div className="flex items-center">
                <img src={GrosMaket} alt="Logo" className="h-10 w-[55%] ml-5" />
            </div>
            
            {/* Conteneur pour la barre de recherche, les notifications et le profil */}
            <div className="flex items-center space-x-4">
                {/* Barre de recherche */}
                <div className="flex items-center border rounded-lg bg-gray-100 w-[60%] max-w-md">
                    <input
                        type="text"
                ...
                {/* Profil */}
                <button className="flex items-center px-4 py-2 border rounded-lg bg-gray-100 text-gray-700 hover:bg-gray-200">
